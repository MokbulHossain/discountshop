<?php include 'php/session.php';session_check(); include 'php/update_post_info.php'; include 'php/header_navbar.php';  ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="post-registration-page">
    ...
    <option value="cars_and_vehicles">Cars And Vehicles</option>
         ...
         <input list="product" name="product_name" placeholder="Enter Your product Name" class="form-control name-box" data-toggle="tooltip" data-placement="top" title="Product Name" required value="<?php echo $product_name; ?>">
  <datalist id="product">
    <option value="Device">
    <option value="Cloth">
  </datalist>
...
<!--  =======Description======-->
            ...
            <label class="post-title" for="name"><i class="fa fa-desktop" aria-hidden="true"></i></label>
               ...
               <textarea rows="4" name="product_discription" cols="50" type="text" class="location-box" data-toggle="tooltip" data-placement="top" title="Description(Max 200 Word)" required ><?php echo $product_discription; ?></textarea>
                </div>
                 <!--  =======Discount======-->
            ...
            <input type="number" name="discount_rate" class="form-control name-box" placeholder="Enter Your Discount" data-toggle="tooltip" data-placement="top" title="Product Name" required min="1" max="100" value="<?php echo $discount_rate; ?>"> 
                </div>
                <!-- Discount start Date -->
                 <div class="field">
             <p>Discount Start Date</p>
            <label class="post-title" for="name"><i class="fa fa-calendar" aria-hidden="true"></i></label>
            <input type="Date" name="discount_start_date" class="form-control" required value="<?php echo $discount_start_date; ?>"> 
                </div>
                <!-- Discount End Date -->
                <div class="field">
             <p>Discount End Date</p>
            <label class="post-title" for="name"><i class="fa fa-calendar" aria-hidden="true"></i></label>
            <input type="Date" name="discount_end_date" class="form-control"  required value="<?php echo $discount_end_date; ?>"> 
                </div>
<!--   ============upload image===========-->
           ...
           <div class="row">
               ...
               <?php if ($product_image) {
               	echo '<a href="#"><img id="blah" src="data:image/jpeg;base64,'.base64_encode($product_image).'" alt="img"></a>'; }
               ...
               <input id="image" name="product_image" required type="file" class="userinput-input" multiple="multiple" onchange="readURL(this);" accept=".jpg,.png,.jpeg">
               </div>
               <div class="col-md-3">
               <div class="intruction">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <button type="submit" style="" class=" btn btn-primary mb1 bg-navy" name="post_submit">Update Post </button>
                  </div>
                </div>
